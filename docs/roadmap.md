...
- [x] Completed thing (moved here when shipped)
...
<!-- Things you've decided NOT to do, and why. Saves you from revisiting the same ideas.
     Example: "Native mobile app — out of scope, web-only by design" -->
