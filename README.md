# StockDB
StockDB is a local database for tracking key statistics about stocks. Note that this is my first rust project, so the rust code quality may not be up to standard.
